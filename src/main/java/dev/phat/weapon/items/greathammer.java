...
public class greathammer extends SwordItem {
    public greathammer(Tier p_43269_, int p_43270_, float p_43271_, Properties p_43272_) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        ...
        components.add(Component.literal("Right click to get a quick attack buff and an attack damage buff."));
    }
}
