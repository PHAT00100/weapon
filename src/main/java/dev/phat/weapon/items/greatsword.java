...
public class greatsword extends SwordItem {
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        if (hand == InteractionHand.MAIN_HAND && !level.isClientSide()) {
            ...
            player.addEffect(new MobEffectInstance(MobEffects.DIG_SPEED, 300, 19));
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level level, List<Component> components, TooltipFlag flag) {
        ...
        components.add(Component.literal("Right-click to get a massive attack damage buff, a massive attack speed buff, and a massive defense buff at the cost of 10 health"));
    }
}
